...
%DIF DEL v0.2/pera_etal.tex   Mon Dec 21 17:42:37 2020
%DIF ADD pera_etal.tex        Mon Dec 21 17:42:30 2020
...
\section{Introduction}
 ...
 Galactic open clusters are of \DIFdelbegin \DIFdel{vital importance in }\DIFdelend \DIFaddbegin \DIFadd{great importance for }\DIFaddend the study of the
 ...
 projected on the observed \DIFdelbegin \DIFdel{frame }\DIFdelend \DIFaddbegin \DIFadd{field of view }\DIFaddend and end up deeply mixed
 with the \DIFdelbegin \DIFdel{true }\DIFdelend \DIFaddbegin \DIFadd{cluster }\DIFaddend members. The process of disentangling these two classes of
 ...
 analysis of the \DIFdelbegin \DIFdel{--hopefully now-- clean }\DIFdelend cluster sequence in search of the
 fundamental parameters (metallicity, age, distance, extinction, etc.) that
 characterize the OC. This analysis\DIFdelbegin \DIFdel{is performed over the photometric
 spaceand }\DIFdelend \DIFaddbegin \DIFadd{, which is often performed in photometric
 space, }\DIFaddend requires a sequence that is as complete as possible, but also as free
 ...
 comparison model, as it is in the previously mentioned methods. \DIFaddbegin \DIFadd{Although
 ...
 The KMM14 article has been referenced almost \DIFdelbegin \DIFdel{40 times}\DIFdelend \DIFaddbegin \DIFadd{50 times, having also being
 applied to stellar proper motions and to study clusters of galaxies, }\DIFaddend in the six
 years span since it was published, which indicates a wide adoption by the
 astrophysical community.

 \DIFdelbegin \DIFdel{We present here }\DIFdelend \DIFaddbegin \DIFadd{Here we present }\DIFaddend an improved version of the original UPMASK algorithm, which we
 call pyUPMASK as it is written entirely in Python. We believe this new package
 can be of great use, particularly with the advent of the \DIFdelbegin \DIFdel{third Gaia data
 release in the very near future. }\DIFdelend \DIFaddbegin \DIFadd{recent early data
 release 3 (eDR3, ) of the the Gaia mission
 }\DIFaddend This package is made available as a
...
\section{Methods}
 ...
 \DIFdelbegin %DIFDELCMD < \url{https://github.com/cran/UPMASK}%%%
...
\subsubsection{Clustering methods}
 ...
 While UPMASK supports the K-Means method exclusively (\DIFdelbegin \DIFdel{at least for now}\DIFdelend \DIFaddbegin \DIFadd{as of the current
 version 1.2}\DIFaddend ), pyUPMASK relies on the Python library
...
\subsection{Input parameters selection}
 ...
 the latest version \DIFaddbegin \DIFadd{(v1.2) }\DIFaddend of the UPMASK code, depending on how it is run, the
...
\section{Results}
 ...
 metrics.
 This is an outstanding result that unmistakably shows the \DIFdelbegin \DIFdel{power of }\DIFdelend \DIFaddbegin \DIFadd{large improvement
 brought by }\DIFaddend pyUPMASK.
 ...
 modification \DIFaddbegin \DIFadd{was motivated by the need of increasing the speed for processing
 large numbers of clusters and }\DIFaddend mainly consists in replacing the default KDE
 ...
 again shows that pyUPMASK \DIFdelbegin \DIFdel{is a much stronger method }\DIFdelend \DIFaddbegin \DIFadd{performed significantly better }\DIFaddend than UPMASK, measured
 ...
 The MST method shows a \DIFdelbegin \DIFdel{rather }\DIFdelend \DIFaddbegin \DIFadd{somewhat }\DIFaddend erratic behavior across the metrics. It
 ...
 Overall, the \DIFaddbegin \DIFadd{statistical }\DIFaddend performance of the MST method is worse than both
 UPMASK and pyUPMASK with any of the tested clustering methods.
 \DIFaddbegin \DIFadd{Notwithstanding, MST is faster than UPMASK (as we show below)
 and outperforms all other methods in the LSR and BSL metrics.}\DIFaddend \\
...
\subsection{Computational resources}
 ...
 cluster from Gaia's second data release\DIFaddbegin \DIFadd{~\mbox{%DIFAUXCMD
\citep{GaiaDR2_2018}}\hspace{0pt}%DIFAUXCMD
...
in~\cite{Cantat_2018}\DIFaddbegin \DIFadd{.
%DIF > 
AM acknowledges support from the Portuguese Fundação para a Ciência e a
Tecnologia (FCT) through the Strategic Programme UID/FIS/00099/2019 for CENTRA}\DIFaddend .
%
