...
\section{Methods}
 ...
 \url{https://github.com/cran/UPMASK}} % TODO final repo link here
...
\subsection{Input parameters selection}
 ...
 the latest version of the UPMASK code, depending on how it is run, the default
 value for $N_{clust}$ is either 25 or 50\footnote{It is 50 if one runs the
 code using the \texttt{UPMASKfile} function, and 25 if one uses the
