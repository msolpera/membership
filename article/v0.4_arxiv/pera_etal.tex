...
\subsubsection{Gaussian-Uniform mixture model}
 ...
 \begin{figure}
 % \resizebox{\hsize}{!}{\includegraphics{GUMM.png}}
 \includegraphics[width=\hsize]{GUMM.png}
...
\subsubsection{Kernel density estimator probabilities}
 ...
 motions space.
  ...
  \begin{figure}
  % \resizebox{\hsize}{!}{\includegraphics{KDE.png}}
  \includegraphics[width=\hsize]{KDE.png}
...
\subsection{Synthetic datasets}
 ...
 \begin{figure}
 \includegraphics[width=\hsize]{synth_clusts.png}
 % \resizebox{\hsize}{!}{\includegraphics{synth_clusts.png}}
...
\subsection{Input parameters selection}
 ...
 \begin{figure}
 % \resizebox{\hsize}{!}{\includegraphics{upmask_N.png}}
 \includegraphics[width=\hsize]{upmask_N.png}
 ...
 % \begin{figure}
 % \includegraphics[width=\hsize]{UP_convergence.png}
...
\section{Results}
 ...
 \begin{figure*}
 \resizebox{\hsize}{!}{\includegraphics{all_methods.png}}
 ...
 \begin{figure}
 \includegraphics[width=\hsize]{matrix.png}
 ...
 \begin{figure*}
 \resizebox{\hsize}{!}{\includegraphics{CI_delta.png}}
 ...
 \begin{figure}
  ...
  \includegraphics[width=\hsize]{time_analysis.png}
...
\subsection{Computational resources}
 ...
 \begin{figure*}
 \resizebox{\hsize}{!}{\includegraphics{NGC2516_CMDs.png}}
