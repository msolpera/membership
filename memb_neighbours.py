...
name, coord_x, coord_y, RA, DE, Plx, pmRA, pmDE = np.array([data['id'], data['x'], data['y'], data['RA_ICRS'], data['DE_ICRS'], data['Plx'], data['pmRA'], data['pmDE']]) 
...
for i in range(len(name)):
    star.append((l*RA_norm[i], l*DE_norm[i], Plx_norm[i], pmRA_norm[i], pmRA_norm[i]))
